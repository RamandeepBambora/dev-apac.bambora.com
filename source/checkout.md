...
Amount | Numeric | Mandatory | Amount entered in cent value e.g. $55.00 = 5500
...
DL | Alpha/Num(16) | Mandatory | This value is used to specify the styling and functionality Bambora should display to your customer. Please see section Payment Page Functionality for full details on DL value. Dl values will be confirmed by Bambora upon account setup.
AccountNumber | Alpha/Num(16) Optional | Mandatory | This value dictates which account the transaction will be processed through. Refer to section Account Hierarchy. If this value is not populated, the transaction will be processed to the account tied to the username field.
CustRef | Alpha/Num(64) | Mandatory | A reference for the transaction sent by you for reporting purposes.
CustNumber | Alpha/Num(64) Optional | Mandatory | An additional reference for the transaction sent by you for reporting purposes.
Email | Alpha/Num(64) Optional | Mandatory | An additional reference for the transaction sent by you for reporting purposes. Please note Bambora can enable this field to send an email receipt to the email address entered in this field. Please contact Bambora if you require this service.
Reference1 | Text(32) Optional | Mandatory | This field name can be changed to something more suitable to your company for example “AccountID”. Please advise if you wish to change it. An additional reference that can be sent by you for reporting purposes e.g. a customer identifier unique to your system. This will be available to view and download with the transaction details in our reporting tool, PRM.
Reference2 | Text(64) Optional | Mandatory | This field name can be changed to something more suitable to your company for example “AccountID”. Please advise if you wish to change it. An additional reference that can be sent by you for reporting purposes e.g. a customer identifier unique to your system. This will be available to view and download with the transaction details in our reporting tool, PRM.
Reference3 | Text(128) Optional | Mandatory | This field name can be changed to something more suitable to your company for example “AccountID”. Please advise if you wish to change it. An additional reference that can be sent by you for reporting purposes e.g. a customer identifier unique to your system. This will be available to view and download with the transaction details in our reporting tool, PRM.
...
Parameter | Format  | Description
--------- | ------- | -----------
SessionId | Alpha/Num(64) | Value that can be either True or False
SST | Alpha/Num(64) | Secure Session Token.  This field will only be populated if the SessionStored value is True.
...
Parameter |  Format | Description
--------- | ------- | -----------
Result | Numeric(1) | 0 = Declined 1 = Approve 2 = In progress 3 = Session Expired
...
CardType | Alpha/Num(16) |	E.g. MasterCard, Visa, American Express, Diners
CardSubType | Alpha/Num(64)	| A value can be passed back giving further details on the card. This field is only returned if you have the CardSubType functionality enabled. Please see section Card SubType Recognition for further information.
TxDateTime | Alpha/Num(19)	| The transaction date/time. Format: YYYY-MM-DD HH:MM:SS E.g. 2010-01-20 18:32:30
...
Surcharge | Numeric(10) | Surcharge amount applied to the transaction in cent value. This is only populated if surcharging is enabled on your account. Please see section Surcharging for further information.
Totalamount | Numeric(10) |	Transaction amount plus surcharge amount applied to the transaction in cent value. This is only populated if surcharging is enabled on your account. Please see section Surcharging for further information.
